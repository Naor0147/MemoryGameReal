...
namespace MemoryGame
{
    class CardClass
    {
        ...
        public void addToGrid(Grid grid)
        {
            ...
            Button2.HorizontalAlignment = Windows.UI.Xaml.HorizontalAlignment.Stretch;
            Button2.VerticalAlignment = Windows.UI.Xaml.VerticalAlignment.Stretch;

            //make the background of the button image
            ImageBrush brush = new ImageBrush();
            brush.ImageSource = Image.Source;
            Button2.Background = brush;
            Grid.SetColumn(Button2, Pos2[0]);
            Grid.SetRow(Button2, Pos2[1]);*/
